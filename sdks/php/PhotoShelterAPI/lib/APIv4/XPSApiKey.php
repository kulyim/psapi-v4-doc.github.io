...
/**
 * XPSApiKey Class Doc Comment
 *
 * @category Class
 * @description Your API key header
 * @package  PhotoShelter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class XPSApiKey implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'X-PS-Api-Key';
