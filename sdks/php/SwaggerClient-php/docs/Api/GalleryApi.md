...
# **galleriesGet**
> \Swagger\Client\Model\InlineResponse200 galleriesGet($page, $per_page, $sort_by, $sort_dir, $name, $parent, $portfolio, $recently_updated)
...
$apiInstance = new Swagger\Client\Api\GalleryApi(
